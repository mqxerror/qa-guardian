/**
 * Flaky Tests - Query Routes (GET endpoints)
 *
 * Read-only endpoints for flaky test analytics:
 * - GET /api/v1/analytics/flaky-tests (flaky test list with scoring)
 * - GET /api/v1/tests/:testId/flakiness-trend (per-test trend over time)
 * - GET /api/v1/ai-insights/flaky-impact-report (business impact analysis)
 * - GET /api/v1/ai-insights/quarantined-tests (quarantined test listing)
 *
...
export async function flakyQueryRoutes(app: FastifyInstance): Promise<void> {
