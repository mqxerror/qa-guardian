/**
 * AI Analysis Helpers Module
 *
 * Vision-based analysis, test code explanation, and screenshot analysis functions.
 * Split from ai-analysis.ts for maintainability.
 *
 * Features:
 * - #1347: Analyze element with vision for selector healing
 * - #1347: Get healing suggestions
...
export function analyzeElementWithVision(
...
export function explainPlaywrightTest(
  code: string,
  testName?: string,
  testType?: string
): {
...
export function generateTestFromAnnotations(
  imageData: string,
  imageType: string,
  baseUrl?: string,
  context?: string,
...
// Page templates for screenshot analysis
...
export function analyzeScreenshotForTest(imageData: string, imageType: string, baseUrl?: string, context?: string): {
