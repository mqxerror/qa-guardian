...
export default function AccessibilityTab({
 ...
 moderate: { bg: 'bg-yellow-100', text: 'text-yellow-700', badge: 'bg-yellow-600' },
 minor: { bg: 'bg-blue-100', text: 'text-blue-700', badge: 'bg-blue-600' },
 };
 return (
 ...
 <div className="text-xl font-bold text-green-700">{a11y.passes}</div>
 ...
 const colors = {
 critical: { border: 'border-red-500', header: 'bg-red-50', badge: 'bg-red-600 text-white' },
 serious: { border: 'border-orange-500', header: 'bg-orange-50', badge: 'bg-orange-600 text-white' },
 moderate: { border: 'border-yellow-500', header: 'bg-yellow-50', badge: 'bg-yellow-600 text-white' },
 minor: { border: 'border-blue-500', header: 'bg-blue-50', badge: 'bg-blue-600 text-white' },
 };
 ...
 violation.impact === 'critical' ? 'border-red-500 bg-red-50' :
 violation.impact === 'serious' ? 'border-orange-500 bg-orange-50' :
 violation.impact === 'moderate' ? 'border-yellow-500 bg-yellow-50' :
