...
import { Loader2, X, CheckCircle2, ChevronRight, Lightbulb, AlertCircle } from 'lucide-react';
import { TestResult, AccessibilityViolation, A11yViewMode } from './types';

// Accessibility result data structure
...
interface AccessibilityTabProps {
 ...
 onAnalyzeAccessibility: (testName: string, a11y: AccessibilityResultData) => Promise<void>;
 aiLoading: boolean;
...
export default function AccessibilityTab({
 ...
 <CheckCircle2 className="w-12 h-12 mx-auto text-success mb-4" strokeWidth={1.5} />
 ...
 <ChevronRight className={`w-4 h-4 transition-transform flex-shrink-0 ${isViolationExpanded ? 'rotate-90' : ''}`} />
