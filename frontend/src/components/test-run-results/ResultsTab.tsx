...
import { Loader2, RefreshCw, ClipboardList, ChevronRight, Check, X, Minus } from 'lucide-react';
...
const ResultsTab = ({
 ...
 <ChevronRight className={`w-5 h-5 text-muted-foreground transition-transform flex-shrink-0 ${isExpanded ? 'rotate-90' : ''}`} />
