      ...
      {incidentData.active_incident && (
        <div className="p-3 rounded-lg bg-red-100 dark:bg-red-900/30 border border-red-200 dark:border-red-800">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="font-medium text-red-700 dark:text-red-300">Active Incident</span>
          </div>
      ...
      {maintenanceData?.in_maintenance && maintenanceData.active_window && (
        <div className="p-3 rounded-lg bg-yellow-100 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="font-medium text-yellow-700 dark:text-yellow-300">In Maintenance</span>
          </div>
