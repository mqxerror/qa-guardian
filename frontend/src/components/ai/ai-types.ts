// AI Router Types - Extracted from AIRouterPage.tsx for Feature #328 refactoring

// Core provider types
export type AIProviderType = 'kie' | 'anthropic';
...
export interface AIRouterConfig {
  ...
  fallback_provider: AIProviderType | 'none';
  enabled: boolean;
  fallback_conditions: {
    on_timeout: boolean;
...
export interface FallbackRule {
  ...
  source_provider: AIProviderType | 'any';
  target_provider: AIProviderType | 'none';
