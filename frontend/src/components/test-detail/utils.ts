...
export const getTestTypeColorClass = (type: TestCategory): string => {
  const colors: Record<TestCategory, string> = {
    'e2e': 'text-blue-600 dark:text-blue-400',
    'visual_regression': 'text-purple-600 dark:text-purple-400',
    'lighthouse': 'text-amber-600 dark:text-amber-400',
    'load': 'text-green-600 dark:text-green-400',
    'accessibility': 'text-indigo-600 dark:text-indigo-400',
...
export const getTestTypeBadgeClass = (type: TestCategory): string => {
  const badges: Record<TestCategory, string> = {
    'e2e': 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400',
    'visual_regression': 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400',
    'lighthouse': 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400',
    'load': 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400',
    'accessibility': 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400',
    'api': 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400',
  };
  return badges[type] || 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400';
};
