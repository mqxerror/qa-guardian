...
export function CurrentRunPanel({
  ...
  const getImpactColor = (impact: string) => {
    switch (impact?.toLowerCase()) {
      ...
      case 'serious': return 'text-orange-600 bg-orange-100 dark:text-orange-400 dark:bg-orange-900/30';
      case 'moderate': return 'text-yellow-600 bg-yellow-100 dark:text-yellow-400 dark:bg-yellow-900/30';
      case 'minor': return 'text-blue-600 bg-blue-100 dark:text-blue-400 dark:bg-blue-900/30';
...
function LiveExecutionPanel({
  ...
  return (
    <div className="mt-4 bg-card border-2 border-blue-500 dark:border-blue-600 rounded-lg p-6 shadow-lg shadow-blue-500/20">
      {/* Header */}
      <div className="flex items-center justify-between mb-4">
