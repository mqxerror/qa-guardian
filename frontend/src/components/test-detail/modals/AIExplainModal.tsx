          ...
          {isLoading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-lg border border-violet-200 dark:border-violet-800 bg-violet-50 dark:bg-violet-900/20 p-4">
                ...
                <p className="text-violet-800 dark:text-violet-200">{explanation.summary}</p>
                <p className="text-sm text-violet-600 dark:text-violet-300 mt-2"><strong>Purpose:</strong> {explanation.purpose}</p>
              </div>

              {/* Complexity Badge */}
              <div className="flex items-center gap-4">
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                  explanation.complexity.level === 'simple' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' :
                  explanation.complexity.level === 'moderate' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300' :
