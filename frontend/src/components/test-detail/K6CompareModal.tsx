        ...
        <div className="p-4 space-y-6">
          ...
          {results.overall && (
            <div className={`p-4 rounded-lg border ${
              results.overall.performance === 'improved' ? 'border-green-500 bg-green-50 dark:bg-green-900/10' :
              results.overall.performance === 'regressed' ? 'border-red-500 bg-red-50 dark:bg-red-900/10' :
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className={`font-semibold ${
                  results.overall.performance === 'improved' ? 'text-green-700 dark:text-green-400' :
                  results.overall.performance === 'regressed' ? 'text-red-700 dark:text-red-400' :
                  'text-foreground'
                }`}>
