 ...
 */
 ...
 disabled={isSubmitting || !testType}
 className="flex-1 py-3 bg-green-600 hover:bg-green-700 disabled:bg-gray-300 text-white font-medium rounded-lg transition-colors disabled:cursor-not-allowed flex items-center justify-center gap-2"
 >
 {submissionPhase ? (
 <>
 <svg className="animate-spin w-5 h-5" fill="none" viewBox="0 0 24 24">
