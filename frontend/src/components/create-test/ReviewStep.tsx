...
const SummaryRow: React.FC<{
 ...
 <div className={`flex justify-between py-2 ${highlight ? 'bg-primary/5 -mx-3 px-3 rounded' : ''}`}>
 ...
 */
 ...
 className="flex items-center gap-2 text-sm text-primary hover:text-primary disabled:opacity-50"
 >
