...
const aiBadgeConfig: Record<AIBadgeType, { icon?: string; label: string; className: string }> = {
  ...
  'ai-powered': {
    icon: undefined,
    label: 'AI Powered',
    className: 'bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/30 text-purple-600 dark:text-purple-400',
  },
  'mcp-ready': {
    icon: undefined,
    label: 'MCP Ready',
    className: 'bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400',
  },
  'ai-ready': {
    icon: undefined,
    label: 'AI Ready',
    className: 'bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-red-500/10 border border-amber-500/30 text-amber-600 dark:text-amber-400',
  },
  'healing': {
    icon: '🔧',
    label: 'Healed',
