...
// Feature #577: Moved to shared utils/scoring.ts — re-exported for backwards compat
// =============================================================================

export type { SuiteHealthBreakdown, TestRunInput, HealthBreakdown } from '../../utils/scoring';
export { computeSuiteHealthScore, computeTestHealthScore } from '../../utils/scoring';
