      ...
      {isAnalyzing ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-lg bg-card border border-border text-center">
              <p className="text-2xl font-bold text-green-600 dark:text-green-400">{plan.optimization.speedup}x</p>
              <p className="text-sm text-muted-foreground">Speedup</p>
            </div>
            <div className="p-4 rounded-lg bg-card border border-border text-center">
              <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{plan.optimization.timeSaved}s</p>
              <p className="text-sm text-muted-foreground">Time Saved</p>
            </div>
            <div className="p-4 rounded-lg bg-card border border-border text-center">
              <p className={`text-2xl font-bold ${
                plan.resourceBalance.balanceScore === 'Excellent' ? 'text-green-600 dark:text-green-400' :
                plan.resourceBalance.balanceScore === 'Good' ? 'text-blue-600 dark:text-blue-400' :
          ...
          <div className="p-4 rounded-lg bg-card border border-border">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-red-600 dark:text-red-400 w-16">{plan.optimization.sequentialTime}s</span>
              </div>
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-green-600 dark:text-green-400 w-16">{plan.optimization.parallelTime}s</span>
              </div>
            </div>
          </div>
