...
export const securityKeys = {
  ...
  // Feature #863: Removed dead dependency page keys (alertsConfig, alerts,
  // policies, violations, vulnerabilityHistory, vulnerabilityStats,
  // multiLangConfig, multiLangStats, allDependencies) after page cuts
};
...
export function useScanSecrets() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      // Feature #110: Also invalidate security trends after scan
...
export function useInvalidateSecurity() {
  ...
  return {
    ...
    // Feature #863: Removed dead invalidation methods (invalidateAlerts,
    // invalidatePolicies, invalidateVulnerabilities) after page cuts
  };
}
