    ...
    <Layout>
      <div className="p-8 max-w-6xl mx-auto">
            ...
            {activeTab === 'zapier' && (
              <div className="space-y-6">
                ...
                <div className="rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 p-4">
                  <h4 className="font-medium text-amber-900 dark:text-amber-100 mb-2">Note on Signature Verification</h4>
            ...
            {activeTab === 'make' && (
              <div className="space-y-6">
                ...
                <div className="rounded-lg bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 p-4">
                  <h4 className="font-medium text-green-900 dark:text-green-100 mb-2">Make + HMAC Verification</h4>
        ...
        <div id="verification" className="mb-8">
          ...
          <div className="mt-6 rounded-lg bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 p-4">
            <h4 className="font-medium text-red-900 dark:text-red-100 mb-2">Security Best Practices</h4>
